...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','net.playcontrol.almixerswig.js')
	...
	f = os.path.join(cwd,'Classes','NetPlaycontrolAlmixerswigModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','net.playcontrol.almixerswig.js']
